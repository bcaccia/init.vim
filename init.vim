...
" Plugins {
	...
	" Add yaml syntax/indent support
	Plug 'mrk21/yaml-vim'
...
" Themes and Colors {
	...
	" needs to be disabled to work with urxvt
	"set termguicolors
...
" Plugin Specific Configuration {
	...
	" FZF Configuration {
		...
		nnoremap <silent> <leader>fw :Files ~/Sync/all/wiki/<CR>
	...
	" tidalcycles Configuration {
		...
		" set plugin to use the built in NeoVim terminal instead of tmux
		let g:tidal_target = "terminal"
		" set leader key to use for default shortcuts 
		let maplocalleader=","
